...
/**
 * Eine Instanz der Klasse Game verwaltet je eine Spielrunde des Spielprotokolls, das auf dem Server laeuft, z.B.
 * Kniffel. Hier werden die Spielerliste (in Form von ServerThreads) und weitere spielrelevante Daten (Name,
 * maximale/minimale Spielerzahl etc.) gespeichert. Desweiteren werden diverse Methoden zur Verwaltung eines Spiels zur
 * Verfuegung gestellt, z.B. Spieler loeschen/hinzufuegen, Verbindung unterbrechen etc.
 *
...
public class Game {
    ...
    /**
     * Konstruktor; erzeugt einen neuen Spieleintrag, der in der Server-eigenen Liste gespeichert wird. Der ServerThread
     * wird im Vector "players" und die weiteren Parameter in entsprechenden Variablen gespeichert. Als letztes wird die
     * Spielerzahl ("1") dem Communicator geschickt.
     *
    ...
    /**
     * Fuegt den ServerThread eines neuen Mitspielers zur bestehenden Spielerliste hinzu und erhoeht die Spieleranzahl
     * ("currentPlayers") um 1. Danach wird die neue Spieleranzahl an alle Mitspieler im Vector "players" gesendet.
     *
    ...
    /**
     * Loescht einen Spieler (also seinen ServerThread) aus dem "players" Vector und sendet die um eins verminderte Zahl
     * an alle uebrigen Spieler.
     *
    ...
    /**
     * Diese Methode unterbricht die Verbindung (im Fehlerfall) zu allen Spielern eines Spiels, wenn das Spiel bereits
     * gestartet ist. Ist das Spiel ncoh nicht gestartet, so wird nur der Spieler, der den Fehler gemeldet hat aus dem
     * Spiel entfernt.
     *
    ...
    /**
     * Sendet an alle Spieler die Nachricht, dass das Spiel gestartet werden kann. Diese Methode wird vom ServerThread
     * des ersten Spielers aufgerufen, nachdem dieser den "Spiel starten"-Button betaetigt hat (siehe auch Diagramm
     * "Spiel starten").
     */
    public void start() {
