...
/**
 * Die Klasse ServerThread uebernimmt eine Clientverbindung, nachdem diese durch den Server initialisiert worden ist, so
 * dass dieser fuer neue Verbindungen wieder zur Verfuegung steht. Sie leitet Nachrichten an den Server weiter, der
 * diese dann (ueber einen weiteren ServerThread) an den entsprechenden Ziel-Client sendet.
 *
...
public class ServerThread extends Thread {
    ...
    /**
     * Konstruktor, uebernimmt eine Socket-Verbindung vom Server, initialisiert die Ein-und Ausgabestreams des Sockets
     * und speichert seine Spielernummer, die er vom Server zugewiesen bekommt. Diese wird dann zuletzt an den
    ...
    /**
     * Empfaengt einen String (blockiert solange, bis der eingestellte TimeOut ueberschritten wurde) ueber die
     * Socket-Verbindung vom Communicator-Objekt des Clients.
     *
	...
	*/
    ...
    /**
     * enthaelt den ausfuehrbaren Code des Threads; hier wird auf Nachrichten gewartet, die dann ueber das Server-Objekt
     * weitergeleitet werden koennen (siehe Methode forward() des Servers). Die Zieladresse der Nachricht wird
     * ueberprueft, um dann die Nachricht an die entsprechende Server-Methode weiterzugeben. Im Fehlerfall wird hier die
     * Verbindung getrennt und die Methode shutdown() auf dem Server aufgerufen, um das Spiel zu entfernen.
     *
     * @throws IOException
    ...
    /**
     * Sendet den String "message" ueber die Socket-Verbindung an das Communicator- Objekt des Clients.
     *
