...
/**
 * Diese Klasse stellt mit einem Kommandozeilenclient eine Alternative zu der Framevariante Client bereit. Sie wurde
 * geschaffen, um das Entwickeln von Protokollen f�r das Kryptologie-Praktikum zu unterst�tzen.
 * <p>
 * Diese Einschr�nkung sorgt somit daf�r, dass hier nur Protokolle mit einer Teilnehmerzahl von 2 ausgef�hrt werden
 * k�nnen.
 * <p>
 * Bitte folgendes durchf�hren, um entsprechendes Protokoll zu testen <ol> <li>Server starten mit
 * <pre>
