...
/**
 * PopWindow zur Ausgabe von Fehlermeldungen. Diese Klasse erzeugt ein Fenster mit entweder einem "Ja" und einem "Nein"
 * Button, oder nur einem "OK" Button. Das Fenster schliesst sich nach dem einer der Button gedrueckt wurde.
 *
...
public class popUpWindow extends Dialog {
    ...
    /**
     * Der Konstruktor erzeugt ein Fenster mit dem String text als Text, einem "Ja" Button und einem "Nein" Button.
     *
     * @param owner "Besitzer" des PopUpFensters
     * @param text  Text der im popUpFensters erscheinen soll
     */
    ...
    /**
     * Die Methode gibt den Wert des Attributs result zurueck. Sie ist "true", wenn der "Ja"-Button gedrueckt wurde.
     * Ansonsten ist sie "false".
     */
