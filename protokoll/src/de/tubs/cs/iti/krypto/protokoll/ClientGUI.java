...
/**
 * Die Klasse ClientGUI stellt die grafische Oberflaeche des Clients dar. Hier werden die Funktionen des Clients fuer
 * den Anwender zugreifbar. Servername, Spielname und Portnummer werden in der grafischen Oberflaeche eingegeben und der
 * Benutzer wird durch Druecken des Buttons "mit Server verbinden" mit dem Server verbunden. Wenn er als erster Spieler
 * am Server angemeldet ist, hat er auch das Recht, das Spiel zu starten. Sonst muss er auf den Spielstart durch einen
 * anderen Mitspieler warten. Ausserdem wird jedem Button ein eigener Event-Listener zugeteilt.
 *
...
public class ClientGUI extends Frame implements Runnable {
    ...
    /**
     * Die Methode uebergibt die "ClientGUI" einem neuen Thread und startet die Methode "run()". Vorher wird versucht,
     * das Spiel mit dem Namen im Feld "theGameClass" zu laden. Ausserdem wird die PortNummer ueberprueft, Servername
     * und Protokollname werden mit "addHistoryItem()" der jeweiligen History Datei hinzugefuegt.
     */
    ...
    /**
     * Aktiviert den Button "ConnectToServer" falls Port-Nummer, Servername und Protokollname eingegeben sind.
     */
    ...
    /**
     * Aktiviert den Button "ConnectToServer" falls Port-Nummer, Servername und Protokollname eingegeben sind. <br>
     */
    ...
    /**
     * Versucht eine Datei mit dem Namen "historyFile" zu lesen und fuegt die Namen aus dieser Datei dem Choice Objekt
     * hinzu.
     *
     * @param choiceHistory Choice-Objekt, dem die History-Eintraege zugewiesen werden sollen.
    ...
    /**
     * Liest eine Datei mit dem Namen "historyFile" zu lesen, fuegt den Namen "newItem" des neuen History-Eintrags der
     * Datei zu, sofern noch nicht vorhanden und fuegt ihn ausserdem  dem Choice Objekt hinzu.
     *
     * @param choiceHistory Choice-Objekt, dem die History-Eintraegezugewiesen werden sollen.
     * @param historyFile   Name der Datei die die History-Eintraege speichert.
    ...
    /**
     * Die Methode schreibt den im String "text" angegebenen Text auf das Label output. <br> Wenn der Client bereits am
     * Server angemeldet ist wird die Spielernummer vor dem Text mitausgegeben. Wenn ein leerer String uebergeben wird,
     * wird nur die Spielernummer erneuert.
     *
