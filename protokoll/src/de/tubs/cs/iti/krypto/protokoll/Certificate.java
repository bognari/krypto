...
/**
 * This is a data class modelling a certificate to be issued by the <cite>TrustedAuthority</cite>-class. <br> Its
 * methods allow access to ID, data and signature of a certificate.
 *
