...
/**
 * Die Klasse Client stellt im Grunde das Hauptprogramm dar. Hier werden die Methoden realisiert, die fuer den Benutzer
 * wichtig sind, wie z.B. der Konstruktor Client, sowie die Methoden zum Anmelden/Abmelden am/vom Server und zum Starten
 * des Spiels.
 *
...
public class Client implements IClient {
    ...
    /**
     * Der Konstruktor von Client erzeugt ein neues ClientGUI-Objekt und ueber gibt sich selbst dem ClientGUI-Objekt.
    ...
    /**
     * Hauptprogramm: Hier werden die Eingabeparameter untersucht und verarbeitet und der Client erzeugt.
     *
    ...
    /**
     * Prueft, ob die Spieleranzahl die Mindestanzahl an Spielern erreicht hat und aktiviert den Button "Spiel
     * Starten".
     *
    ...
    /**
     * Besorgt sich zunaechst die spielrelevanten Daten von seinem Spielprotokoll. Danach erzeugt sie ein neues Objekt
     * vom Typ Communicator und uebergibt diesem die Spieldaten sowie den gewuenschten Servernamen/Port.<br> Als letztes
     * ruft der Client noch die Methode setCommunicator() des Spielprotokolls auf, um die neue Verbindung mit dem
     * Spielprotokoll zu verknuepfen.
     *
    ...
    /**
     * Ueberprueft, ob Communicator Objekt vorhanden ist, wenn dies der Fall ist, wird an den Server die
     * Abmelde-Nachricht geschickt und das Communicator Objekt auf null gesetzt.
     */
    ...
    /**
     * Testet ob bereits ein Communicator Objekt erzeugt wurde(also ob man am Server angemeldet ist) und schickt dann,
     * wenn notwendig dem Server, dass er sich beendet. Dann wird der Client beendet.
     */
    public void exit() {
        if (myCom != null) {
            myCom.sendTo(-2, String.valueOf(myCom.myNumber()));
    ...
    /**
     * Diese Methode macht das Client Fenster wieder sichtbar, benachrichtigt den Anwender mittels eines popUpFensters
     * ueber den Abbruch des Spiels durch einen anderen Spieler und Schliesst den Client danach. Die Methode wird vom
     * Communicator aufgerufen, wenn ein anderer Spieler das laufende Spiel abbricht.
     *
