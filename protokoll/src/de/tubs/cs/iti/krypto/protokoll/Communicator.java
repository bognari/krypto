...
/**
 * Die Klasse Communicator dient als Kommunikationsschnittstelle zwischen den Protokollen und dem Server. Im
 * Communicator werden Methoden realisiert, die den Datenaustauch zwischen den Parteien des Netzwerks ueber den Server
 * ermoeglichen.
 *
...
public class Communicator {
    ...
    /**
     * Der Konstruktor zur Klasse Communicator erzeugt eine neue Kommunikations- schnittstelle, die vom Client "client"
     * benutzt wird. Im Konstruktor wird eine Socketverbindung zum Server aufgebaut, zwei Streams zur Kommunikation
     * initialisiert und die fuer die Kommunikation notwendigen Variablen Spielname Minimal/Maximalspielerzahl
     * initialisiert. Danach werden diese Daten an den Server uebermittelt, der dann die entsprechende Spielernummer
    ...
    /**
     * Diese Methode realisiert den Empfang von Daten von anderen Spielern. Im Fehlerfall (Nachricht undefiniert) wird
     * die Verbindung getrennt und das Programm mit Ausgabe einer Fehlermeldung abgebrochen.
     *
    ...
    /**
     * Die Methode sendTo sendet einen String zum Spieler mit der Spielernummer player. Die Nachricht wird mit der
     * Zieladresse und dem Spielnamen verknuepft.
     *
    ...
    /**
     * diese Methode wird nach Erzeugen des Communicator-Objektes gestartet, um vor Beginn des Spiels auf
     * hinzukommende/sich abmeldende Spieler zu warten Falls der Client sich vor Beginn des Spiels abmeldet, liefert die
     * Methode den Wert "false". Bei erfolgreicher Anmeldung und Start des Spiels liefert sie "true" zurueck.
     *
